 ...
 * @author Index
 */
public class RPGeodataParser extends AbstractGeodataParser
{
    public RPGeodataParser(File pathToFile)
    {
        super(GeodataExtensions.RP, pathToFile);
    }

    @Override
    public GeoRegion read()
    {
        // idk why someone wants to make this - the same l2d format.
        GeoRegion geoRegion = new GeoRegion(getXYcord()[0], getXYcord()[1]);
